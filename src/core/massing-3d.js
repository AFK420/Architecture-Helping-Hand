...
import {
  generateClampedKnotVector, evaluateNurbsCurve, evaluateNurbsSurface, tessellateNurbsSurface
} from './nurbs-core.js';
// Backwards-compatible re-exports (public API unchanged):
export { generateClampedKnotVector, evaluateNurbsCurve, evaluateNurbsSurface, tessellateNurbsSurface };
...
import {
  extrudeFaces, loftFaces, revolveFaces, solidBoxFaces, subdLimitQuads
} from './cad-3d-entities.js';
